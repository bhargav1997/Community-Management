...
import { GreenButton, PurpleButton } from "../../../styled-components/buttonStyles";
...
const ChooseSubject = ({ situation }) => {
   ...
   if (loading) {
      ...
      return (
         <div>
            <h1>Sorry all subjects have House Leaders assigned already</h1>
            <Box sx={{ display: "flex", justifyContent: "flex-end", marginTop: "16px" }}>
               <PurpleButton variant='contained' onClick={() => navigate("/Admin/addevent/" + classID)}>
                  Add Subjects
               </PurpleButton>
            </Box>
         </div>
                        ...
                        subjectsList.map((subject, index) => (
                           <StyledTableRow key={subject._id}>
                              ...
                              <StyledTableCell align='center'>
                                 {situation === "Norm" ? (
                                    <GreenButton variant='contained' onClick={() => navigate("/Admin/hleaders/addhLeader/" + subject._id)}>
                                       Choose
                                    </GreenButton>
                                 ) : (
                                    <GreenButton
