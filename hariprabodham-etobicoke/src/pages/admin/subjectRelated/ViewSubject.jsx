      ...
      return (
         <>
            ...
            <Typography variant='h6' gutterBottom>
               Event Name : {subjectDetails && subjectDetails.subName}
            </Typography>
            <Typography variant='h6' gutterBottom>
               Event Code : {subjectDetails && subjectDetails.subCode}
            </Typography>
            <Typography variant='h6' gutterBottom>
               Event Sessions : {subjectDetails && subjectDetails.sessions}
            </Typography>
            <Typography variant='h6' gutterBottom>
               Number of House Members: {numberOfStudents}
            </Typography>
            <Typography variant='h6' gutterBottom>
               House Name : {subjectDetails && subjectDetails.sclassName && subjectDetails.sclassName.sclassName}
            </Typography>
            {subjectDetails && subjectDetails.teacher ? (
               <Typography variant='h6' gutterBottom>
                  House Leader Name : {subjectDetails.teacher.name}
               </Typography>
            ) : (
               <GreenButton variant='contained' onClick={() => navigate("/Admin/hleaders/addhLeader/" + subjectDetails._id)}>
                  Add House Leader
               </GreenButton>
            )}
         </>
