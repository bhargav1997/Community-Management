...
import { deleteUser, getUserDetails, updateUser } from "../../../redux/user/userHandle";
...
import { StyledTableCell, StyledTableRow } from "../../../styled-components/styles";
         ...
         return (
            <>
               ...
               <Button
                  ...
                  onClick={() => navigate("/Admin/housemembers/hmember/attendance/" + studentID)}>
                  Add Attendance
               </Button>
            </>
         );
         ...
         return (
            <>
               ...
               <Button
                  variant='contained'
                  sx={styles.styledButton}
                  onClick={() => navigate("/Admin/housemembers/hmember/marks/" + studentID)}>
                  Add Marks
               </Button>
            </>
         );
   ...
   const StudentDetailsSection = () => {
      return (
         <div>
            ...
            <br />
            Phone Number: {userDetails.rollNum}
            <br />
            House: {sclassName.sclassName}
            <br />
            Mandal Name: {studentSchool.schoolName}
            {subjectAttendance && Array.isArray(subjectAttendance) && subjectAttendance.length > 0 && <CustomPieChart data={chartData} />}
                ...
                <Collapse in={showTab} timeout="auto" unmountOnExit>
                    <div className="register">
                        <form className="registerForm" onSubmit={submitHandler}>
                            ...
                            <input className="registerInput" type="number" placeholder="Enter user's Phone Number..."
                                value={rollNum}
