...
import { Box, Button, CircularProgress, Collapse, Table, TableBody, TableHead, Typography } from "@mui/material";
      ...
      <>
         {loading ? (
            ...
            <div>
               ...
               <Button
                  variant='contained'
                  onClick={() => navigate(`/HouseLeader/house/house-member/attendance/${studentID}/${teachSubjectID}`)}>
                  Add Attendance
               </Button>
               <br />
               <br />
               ...
               <PurpleButton
                  variant='contained'
                  onClick={() => navigate(`/HouseLeader/house/house-member/marks/${studentID}/${teachSubjectID}`)}>
                  Add Marks
               </PurpleButton>
               <br />
               <br />
